...
recipeItem1 = Recipe(user_id=1, name="Strawberry Bruschetta", description="1) Preheat your oven's broiler. Spread a thin layer of butter on each slice of bread. Arrange bread slices in a single layer on a large baking sheet. 2) Place bread under the broiler for 1 to 2 minutes, just until lightly toasted. Spoon some chopped strawberries onto each piece of toast, then sprinkle sugar over the strawberries. 3) Place under the broiler again until sugar is caramelized, 3 to 5 minutes. Serve immediately.",
                     ingredients="24 slices French baguette;1 tablespoon butter, softened;2 cups chopped fresh strawberries;1/4 cup white sugar, or as needed;", prep_time="15m", category=category1, picture="https://pbs.twimg.com/media/C-ldyjYUQAApMDk.jpg")
